...
class PeopleViewController: UIViewController {
    ...
    let users = Bundle.main.decode([UserNearbyModel].self, from: "Users.json")
    var collectionView: UICollectionView!
    var dataSource: UICollectionViewDiffableDataSource<Section, UserNearbyModel>!
...
//        navigationController?.navigationBar.shadowImage = UIImage()
    ...
    private func reloadData(with searchText: String?) {
        ...
        var snapshot = NSDiffableDataSourceSnapshot<Section, UserNearbyModel>()
...
extension PeopleViewController {
    ...
    private func createDataSource() {
        dataSource = UICollectionViewDiffableDataSource<Section, UserNearbyModel>(collectionView: collectionView, cellProvider: { (collectionView, indexPath, itemIdentifier) -> UICollectionViewCell? in
